...
export default function Home() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-center text-3xl font-bold mb-4 underline">C2DeFi</h1>
      <p className="mb-4">
      ...
      <div className="text-center">
        <Link href="/posts">
          <span className="inline-block py-2 px-4 rounded  text-xl underline">Explore Posts</span>
        </Link>
      </div>
